...
class QualityReport(Base):
    ...
    urea_mg = Column(Float, nullable=True)
    water_addition_pct = Column(Float, nullable=True)
    starch_test = Column(Integer, nullable=True)
    detergent_test = Column(Integer, nullable=True)
